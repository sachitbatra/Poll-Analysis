...
<head>
  <link rel="stylesheet" href="winConstituency.css">
</head>
<body>
  ...
  $result = mysql_query("SELECT party_id, party, constituency_id, constituency, MAX(votes) 'votes' FROM constituency_votes GROUP BY constituency_id");
  ?>
