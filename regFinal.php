...
<div id="candidateReg">
  <form id="candidateForm" method="get" action="candidateReg.php">
    <pre><i class="fa fa-user-circle"></i> <input type="text"  class="inp" placeholder="Enter Your Name" id="candName" name="name"> </input></pre>
    <pre><i class="fa fa-male" aria-hidden="true"></i> <input type="text" id="gender" class="inp" placeholder="M/F" name="gender"> </pre>
    ...
    <pre><i class="fa fa-users" aria-hidden="true"></i> <select class="inp"  placeholder="Enter Your Party ID" id="pid" name="party">
        <?php
            $servername = "localhost";
            $username = "root";
            $password = "";
            ...
            $sql = "SELECT party_id FROM political_party";
            $result = mysql_query($sql);
